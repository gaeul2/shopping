...
from product.serializers import ProductSerializer, ProductInfoSerializer,ReviewSerializer
    ...
    def post(self, request, product_id):
        try:
            ...
            if review_serializer.is_valid():
                ...
                return Response(f'{product.name}에 대한 {request.user.fullname} 님의 리뷰가 등록되었습니다.', status=status.HTTP_200_OK)
